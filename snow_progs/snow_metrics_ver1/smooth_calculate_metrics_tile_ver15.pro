...
pro smooth_calculate_metrics_tile_ver15,filen,flg

;test

;filen='/home/jiang/nps/cesu/modis_ndvi_250m/wrkdir/2010_multiyear_layer_stack_0_200_set_snow_cloud_n4000'
filen='/mnt/jzhu_scratch/EMODIS-NDVI-DATA/wrk/ver_new_201107/2008/ver16/2008_multiyear_layer_stack'

;filen='/raid/scratch/cesu/eMODIS/ver_new_201107/2008-prod/ver10/2008_oneyear_layer_subset_good'
;
;
...
if i EQ 13 and j EQ 9930 then begin
...
if i mod 100 EQ 0  and j EQ 9346 then begin
...
time_series_process_nps_oneyear_ver15,tmp,bnames,threshold,snowcld,mid_interp,mid_smooth,mid_bq,mid_bname,vmetrics
