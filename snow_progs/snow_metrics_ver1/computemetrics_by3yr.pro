FUNCTION ComputeMetrics_by3yr, NDVI_3yr, bq_3yr, bn_3yr, wl, bpy, CurrentBand, DaysPerBand;dt
...
;
   SOS=GetSOS_ver15(Starts, NDVI,bq,Time, bpy, FMA) ;dayindex of start season and related ndvi value
   EOS=GetEOS_ver15(Ends, NDVI,bq,Time, bpy, SOS,bma)   ;dayindex of end season and related ndvi value
