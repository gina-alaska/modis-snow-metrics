...
pro cutoff_interp_ver15, vcomp, vcomp_bq, vcomp_g
...
;0b-valid,1b-cloudy,2b-bad,3b-negative reflectance,4b-snow,10b-fill, 20b-fill type for extension points of data
...
idxv = where( (vcomp_bq EQ 0b or vcomp_bq EQ 4b or vcomp_bq EQ 20b ), cnt, complement=idx) ; valid and snow pixels
