...
pro smooth_calculate_snowmetrics_tile_terra_only,filen,ver,flg
...
;test
;terra files
filen_cover='/center/w/jzhu/nps/snow-metrics/2009/2009_snow_cover'
filen_fract='/center/w/jzhu/nps/snow-metrics/2009/2009_snow_fract'
filen_quali='/center/w/jzhu/nps/snow-metrics/2009/2009_snow_quali'
filen_albed='/center/w/jzhu/nps/snow-metrics/2009/2009_snow_albed'

ver='0801_0731_ver5_2'
...
fileout_cover=wrkdir+filebasen+'_cover_'+ver

openw,unit_cover,fileout_cover,/get_lun


fileout_smooth=wrkdir+filebasen+'_fract_'+ver
...
bnames_metrics = ['first_day','last_day','fss_range','css_first_day','css_last_day','css_day_range','snow_days','no_snow_days','css_segment_num','mflag','cloud_days','reserved','reserved','reserved']
vmetrics=intarr(14);
...
if i EQ 3434 and j EQ 3248 then begin
