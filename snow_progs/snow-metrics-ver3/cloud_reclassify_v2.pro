...
1: begin   ;backward, snow ->snow
   ...
   for k=cnt-1, 0, -1 do begin  ;<2>
    ...
    while wrk_cover(tmpk-1) EQ 50 or $
          wrk_cover(tmpk-1) EQ 11 or $
          wrk_cover(tmpk-1) EQ 255 or $
          wrk_cover(tmpk-1) EQ 0 do begin ;<4>, think fill, night,or missing point as cloud point
...
2: begin  ;backward, no-snow ->no-snow
   ...
   for k=cnt-1, 0, -1 do begin  ;<2>
    ...
    while wrk_cover(tmpk-1) EQ 50 or $ 
          wrk_cover(tmpk-1) EQ 11 or $
          wrk_cover(tmpk-1) EQ 255 or $
          wrk_cover(tmpk-1) EQ 0 do begin ;<4>
