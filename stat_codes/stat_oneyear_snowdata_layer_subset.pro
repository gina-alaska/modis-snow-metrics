pro stat_oneyear_snowdata_layer_subset,flist_cover, flist_fract,flist_quali,flist_albed, upper_l_lon,upper_l_lat, lower_r_lon,lower_r_lat
...
stat_read_snowdata, wrkdir,fn_cover,fn_fract,fn_quali,fn_albed, ul, lr,rt_fid_cover,rt_fid_fract,rt_fid_quali,rt_fid_albed
...
;---- layer stacking cover,fract, and quali, seperately.  ------------------
  ...
  out_name = wrkdir+year+'_snow_cover_raw'
...
;---- stack fract together
 ...
 ;fist file id is flist[0].fid
  ...
  out_name = wrkdir+year+'_snow_fract_raw'
...
;---- stack quali together
 ...
 ;fist file id is flistt[0].fid
  ...
  out_name = wrkdir+year+'_snow_quali_raw'
...
;---- stack quali together
 ...
 ;fist file id is flistt[0].fid
  ...
  out_name = wrkdir+year+'_snow_albed_raw'
