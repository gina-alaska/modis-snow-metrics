...
if cnt EQ 0 then begin  ;<1> not any "snow" day
  ...
  ;metrics[6] = cnt ; num of snow days
  ;metrics[7] = totnosnow; num of no-snow days
...
;method 2
;
 get_css_indics_v6, newcv, fract, albed, quali, bname, first_idx, last_idx, 14,           2,      day_str, num_css,stidx, edidx, totnumsnow,totnosnow,totcloud,tot_css_days,longest_css_days
;get_css_indics_v6, newcv, fract, albed, quali, bname, first_idx, last_idx, css_snow_day ,gapday, day_str, num_css,stidx, edidx, totnumsnow,totnosnow,totcloud,tot_css_days
...
;;bnames_metrics = ['first_day','last_day','day_range','css_first_day','css_last_day','css_day_range','snow_days','no_snow_days','css_num','mflag',totcloud]
...
if css_days NE longest_css_days then begin
  
  print,'check it, must be something is wrong!'
