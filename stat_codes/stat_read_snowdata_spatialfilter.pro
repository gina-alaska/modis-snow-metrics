...
pro stat_read_snowdata_spatialfilter,wrkdir,fn_cover,fn_fract,fn_quali,fn_albed, ul,lr, rt_fid_cover,rt_fid_fract,rt_fid_quali, rt_fid_albed
...
;free_lun, layer_fid, subset_fid, t_fid, d_fid, q_fid, b_fid; FREE_LUN: File unit is not within allowed range: 132
