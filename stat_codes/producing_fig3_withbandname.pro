pro producing_fig3_withbandname, filen

;filen is 3d array snow cover file, such as 2012_snow_cover and 2012_snow_cover.hdr
;

;data_fn='/Users/jzhu/projects/nps/snow_metrics_data/2012/2012_snow_cover'

data_fn='/center/w/jzhu/nps/snow_metrics/2012/2012_snowyear_gl_stat1'

;landmsk_fn='/import/c/w/jzhu/nps/snow_metrics/2012/land_mask'

;landmsk_fn='/Users/jzhu/projects/nps/snow_metrics_data/2012/landmask_nan_by_mflg'
landmsk_fn='/center/w/jzhu/nps/snow_metrics/2012/landmask_nan_by_mflg'
...
;output band name of pct

pct_bandname=bnames1

outfile=file_dirname(data_fn)+'/'+file_basename(data_fn)+'-pct-bandname.dat'
